...
from .api import get_or_create_conversation, get_conversation_messages, get_conversation_media, get_chat_style, \
    update_chat_style
...
urlpatterns = [
    ...
    path('api/images/', get_conversation_media, name='get_conversation_media'),
    path('api/conversation/media/', get_conversation_media, name='get_conversation_media'),
